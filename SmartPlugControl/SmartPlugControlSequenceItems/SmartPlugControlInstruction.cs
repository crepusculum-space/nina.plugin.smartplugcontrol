...
namespace Crepusculum.NINA.SmartPlugControl.SmartPlugControlTestCategory {
    /// <summary>
    ...
    public class SmartPlugControlInstruction : SequenceItem {
        /// <summary>
        ...
        public SmartPlugControlInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public SmartPlugControlInstruction(SmartPlugControlInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new SmartPlugControlInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(SmartPlugControlInstruction)}, Text: {Text}";
        }
    }
}
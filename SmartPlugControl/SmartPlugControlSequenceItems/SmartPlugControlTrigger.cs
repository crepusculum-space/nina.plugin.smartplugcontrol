...
namespace Crepusculum.NINA.SmartPlugControl.SmartPlugControlTestCategory {
    ...
    public class SmartPlugControlTrigger : SequenceTrigger {
        /// <summary>
        ...
        public SmartPlugControlTrigger() {
        }

        public override object Clone() {
            return new SmartPlugControlTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(SmartPlugControlTrigger)}";
        }
    }
}
...
namespace Crepusculum.NINA.SmartPlugControl.SmartPlugControlDrivers {
    ...
    /// </summary>
    public class SmartPlugControlWeatherDriver : BaseINPC, IWeatherData {
        public SmartPlugControlWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"SmartPlugControl Weather Data ({deviceId})";
        ...
        public string Category => "SmartPlugControl Weather Driver";

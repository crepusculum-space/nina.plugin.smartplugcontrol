...
namespace Crepusculum.NINA.SmartPlugControl.SmartPlugControlTestCategory {
    ...
    public class SmartPlugControlCondition : SequenceCondition {
        /// <summary>
        ...
        public SmartPlugControlCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new SmartPlugControlCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(SmartPlugControlCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}
...
namespace Crepusculum.NINA.SmartPlugControl.SmartPlugControlDockables {
    ...
    public class SmartPlugControlDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public SmartPlugControlDockable(
            ...
            dict.Source = new Uri("Crepusculum.NINA.SmartPlugControl;component/SmartPlugControlDockables/SmartPlugControlDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Crepusculum.NINA.SmartPlugControl_AltitudeSVG"];

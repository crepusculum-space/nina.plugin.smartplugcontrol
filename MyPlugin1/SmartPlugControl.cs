...
namespace Crepusculum.NINA.SmartPlugControl {
    ...
    /// The user interface for the settings will be defined by a DataTemplate with the key having the naming convention "SmartPlugControl_Options" where SmartPlugControl corresponds to the AssemblyTitle - In this template example it is found in the Options.xaml
    /// </summary>
    ...
    public class SmartPlugControl : PluginBase, INotifyPropertyChanged {
        ...
        private readonly ImagePattern exampleImagePattern = new ImagePattern("$$EXAMPLEPATTERN$$", "An example of an image pattern implementation", "Smart Plug Control");

        [ImportingConstructor]
        public SmartPlugControl(IProfileService profileService, IOptionsVM options, IImageSaveMediator imageSaveMediator) {
